...
for (i = 0; i < ccountry.length; i++) {
	...
	document.getElementById("longitude").innerHTML = "⦿ Country's Longitude: <b>" + ccountry[i].CapitalLongitude + "</b>";
	document.getElementById("latitude").innerHTML = "⦿ Country's Latitude: <b>" + ccountry[i].CapitalLatitude + "</b>";
	document.getElementById("latitude").innerHTML = "⦿ Country's Code: <b>" + ccountry[i].CountryCode + "</b>";
} 
}
}